...
const dropdownNavsAreas=[
    ...
    // {
    //     title: "Shoonya",
    //     desc: "Open-source workbench for AI-assisted language work on Indian languages with initial focus on translation.",
    ...
    // {
    //     title: "Chitralekha",
    //     desc: "Open-source tool for AI-assisted video subtitling and translating with a focus on educational and media content.",
    //     path: "javascript:void(0)",
    //     icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    //         <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" />
    //     </svg>
    ...
    // {
    //     title: "Anuvaaad",
    //     desc: "Open-sourced tool for document-level translation with NMT and transliteration support.",
    //     path: "javascript:void(0)",
    //     icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    //         <path d="M18.375 2.25c-1.035 0-1.875.84-1.875 1.875v15.75c0 1.035.84 1.875 1.875 1.875h.75c1.035 0 1.875-.84 1.875-1.875V4.125c0-1.036-.84-1.875-1.875-1.875h-.75zM9.75 8.625c0-1.036.84-1.875 1.875-1.875h.75c1.036 0 1.875.84 1.875 1.875v11.25c0 1.035-.84 1.875-1.875 1.875h-.75a1.875 1.875 0 01-1.875-1.875V8.625zM3 13.125c0-1.036.84-1.875 1.875-1.875h.75c1.036 0 1.875.84 1.875 1.875v6.75c0 1.035-.84 1.875-1.875 1.875h-.75A1.875 1.875 0 013 19.875v-6.75z" />
    //     </svg>
...
export default function AppbarTest () {
    ...
    const navigation = [
        ...
        { title: "Areas", path: "/areas", isDrapdown: true, navs: dropdownNavsAreas },
    ...
    return (
        <>
            <nav className={`relative z-20 bg-[#F2F3F7] w-full md:static md:text-sm md:border-none ${state ? "shadow-lg rounded-b-xl md:shadow-none" : ""}`}>
                                        ...
                                        <li key={idx}>
                                            {
                                                item.isDrapdown ? (
                                                    <button className="w-full flex items-center justify-between gap-1 text-gray-700 hover:text-indigo-600"
                                                        onClick={() => {
                                                            setDrapdownState({ isActive: !drapdownState.isActive, idx })
                                                        }
                                                    }
                                                    >
                                                        {item.title}
